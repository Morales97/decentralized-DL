...
def make_optimizer_class(cls):
    class DPOptimizerClass(cls):
        def __init__(self, l2_norm_clip, noise_multiplier, minibatch_size, microbatch_size, *args, **kwargs):
            # pdb.set_trace()
            filtered_kwargs = {'params': kwargs['params'], 'lr': kwargs['lr'], 'weight_decay': kwargs['wd'], 'momentum': kwargs['momentum']}
            super(DPOptimizerClass, self).__init__(*args, **filtered_kwargs)
