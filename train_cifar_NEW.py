...
def train(args, steps, wandb):
    ...
    while epoch < args.epochs:
        ...
        # lr decay
        if lr_decay_phase < total_lr_phases and epoch/args.epochs > args.lr_decay[lr_decay_phase]:
            for opt in opts:
                for g in opt.param_groups:
                    g['lr'] = g['lr']/10
...
# python train_cifar_NEW.py --lr=3.2 --topology ring fully_connected --local_steps 0 0 --dataset=cifar100 --wandb=False --local_exec=True --n_nodes 8 16 --start_epoch_phases 0 1