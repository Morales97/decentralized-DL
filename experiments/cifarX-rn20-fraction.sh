#!/bin/sh
python train_cifar.py --dataset=cifar$1 --expt_name=solo_baseline_$2 --data_fraction=$2 --n_nodes=1 --lr=0.2 --topology=solosteps_eval=60 --lr_warmup_epochs=0 --seed=0 &
python train_cifar.py --dataset=cifar$1 --expt_name=solo_baseline_$2 --data_fraction=$2 --n_nodes=1 --lr=0.2 --topology=solosteps_eval=60 --lr_warmup_epochs=0 --seed=1 &
