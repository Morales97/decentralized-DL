...
python train_cifar.py --dataset=cifar$1 --expt_name=C2.2_$2 --data_fraction=$2 --topology fully_connected fully_connected fully_connected --local_steps 0 0 0 --n_nodes 8 16 32 --start_epoch_phases 0 100 200 --lr_decay 300 --eval_on_average_model=True --steps_eval=15 --seed=0 &
python train_cifar.py --dataset=cifar$1 --expt_name=C2.2_$2 --data_fraction=$2 --topology fully_connected fully_connected fully_connected --local_steps 0 0 0 --n_nodes 8 16 32 --start_epoch_phases 0 100 200 --lr_decay 300 --eval_on_average_model=True --steps_eval=15 --seed=1 &
wait