...
# baseline for rn18
python train_cifar.py --n_nodes=1 --lr=0.1 --epochs=225 --epoch_swa=126 --epoch_swa_budget=150 --swa_lr=0.05 --lr_decay=226 --alpha=0.999 --topology=solo --data_split=True --steps_eval=400 --dataset=cifar$1 --net=rn18 &
